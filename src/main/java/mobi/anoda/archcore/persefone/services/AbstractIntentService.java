...
/**
 * Originally taken API19#{@link IntentService} with replaced hierarchy parent node
 *
 * author: Archinamon
 * project: Wallpapers2
 */
public abstract class AbstractIntentService extends AbstractService {

    /**
     * Simple name-replacing to differentiate binders for {@link AbstractIntentService}s
     */
    public final class RendezvousBinder extends GraphBinder {}
