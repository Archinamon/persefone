...
package mobi.anoda.archcore.persefone.ui.widget.shareprovider;
...
import mobi.anoda.archcore.persefone.ui.widget.shareprovider.ActivityChooserModel.ActivityChooserModelClient;
import mobi.anoda.archcore.persefone.ui.widget.shareprovider.ActivityChooserModel.ActivityResolveInfo;
...
public class ShareView extends ViewGroup implements ActivityChooserModelClient {
     ...
     * </p>
     *
     * @param view The source of the notification.
	...
	public ShareView(Context context, AttributeSet attrs, int defStyle) {
		...
		mExpandActivityOverflowButtonImage = (ImageView) mExpandActivityOverflowButton.findViewById(R.id.image_expand);
		...
		mDefaultActivityButtonImage = (ImageView) mDefaultActivityButton.findViewById(R.id.image_default);
		...
		mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.sv__preferred_dialog_width));
	}
	 ...
	 */
	private class Callbacks implements OnClickListener,
                                       OnLongClickListener,
