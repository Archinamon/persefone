...
/**
 * Static class containing string constants for the most common Internet content types. It's not meant to be a complete enumeration of all the known content types, so don't worry if you don't find what you're looking for.
 * <p/>
 * A complete and official list can be found here: https://www.iana.org/assignments/media-types
 *
