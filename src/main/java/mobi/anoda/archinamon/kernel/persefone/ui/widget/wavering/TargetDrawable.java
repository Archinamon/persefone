package mobi.anoda.archinamon.kernel.persefone.ui.widget.wavering;
...
public class TargetDrawable {
    ...
    private static final String  TAG            = TargetDrawable.class.getSimpleName();
    private static final boolean DEBUG          = false;
    public static final  int[]   STATE_ACTIVE   = {android.R.attr.state_enabled,
                                                   android.R.attr.state_active};
    public static final  int[]   STATE_INACTIVE = {android.R.attr.state_enabled,
                                                   -android.R.attr.state_active};
    public static final  int[]   STATE_FOCUSED  = {android.R.attr.state_enabled,
                                                   -android.R.attr.state_active,
    ...
    /**
     * This is changed from the framework version to pass in the number of drawables in the container. The framework version relies on private api's to get the count from StateListDrawable.
     *
     * @param res
     * @param resId
