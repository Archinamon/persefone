...
public class SwipeHelper {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mCurrView != null) {
                    View button = mCurrView.findViewById(R.id.swipe_lock_item);
                    ...
                    if (button != null) {
                        ...
                        mProtected = rawX > left && rawY > top && rawY < bottom;
                    }
                    ...
                    Log.v("delay", "mInitialTouchPosX:------" + String.valueOf(mInitialTouchPosX));
                    mInitialTouchPosY = ev.getY();
                    Log.v("delay", "mInitialTouchPosY-------" + String.valueOf(mInitialTouchPosY));
                }
                break;
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    mVelocityTracker.addMovement(ev);
                    float pos = ev.getX();
                    float delta = pos - mInitialTouchPosY;
                    if (Math.abs(delta) > mPagingTouchSlop) {
                        mCallback.onBeginDrag(mCallback.getChildContentView(mCurrView), delta);
                        mDragging = true;
                        mInitialTouchPosX = ev.getX() ;
                        mInitialTouchPosY = ev.getY()- mCurrAnimView.getTranslationX();
                    }
                }
                mLastY = ev.getY();
                break;
        ...
        anim.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                if (FADE_OUT_DURING_SWIPE && canAnimViewBeDismissed) {
                    ...
                    mCallback.onBeginDrag(animView, animView.getTranslationY());
                }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    float deltaY = (ev.getY() - mInitialTouchPosY);
                    ...
                    if (CONSTRAIN_SWIPE && !mCallback.canChildBeDismissed(mCurrView)) {
                        ...
                        float maxScrollDistance = 1f * size;
                        if (Math.abs(deltaY) >= size) {
                            deltaY = deltaY > 0 ? maxScrollDistance : -maxScrollDistance;
                        } else {
                            deltaY = maxScrollDistance * (float) Math.sin((deltaY / size) * (Math.PI/2));
                        }
                    }

                    setTranslation(mCurrAnimView, deltaY);
                    mCallback.onBeginDrag(mCurrView, deltaY);
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mCurrView != null) {
                    ...
                    mVelocityTracker.computeCurrentVelocity(100 /* px/sec */, maxVelocity);
                    ...
                    // swipe/dismiss
                    float translation = Math.abs(mCurrAnimView.getTranslationY());
                    float currAnimViewSize = getSize(mCurrAnimView);
                    // Long swipe = translation of .4 * width
                    boolean childSwipedFarEnough = DISMISS_IF_SWIPED_FAR_ENOUGH && translation > 0.7 * currAnimViewSize;
                    // Fast swipe = > escapeVelocity and translation of .1 *
                    // width
                    boolean childSwipedFastEnough = (Math.abs(velocity) > escapeVelocity)
                                                    && (Math.abs(velocity) > Math.abs(perpendicularVelocity))
                                                    && (velocity > 0) == (mCurrAnimView.getTranslationY() > 0)
                                                    && translation > 0.1 * currAnimViewSize;
    ...
    public interface Callback {
        ...
        void onBeginDrag(View v, float diff);
