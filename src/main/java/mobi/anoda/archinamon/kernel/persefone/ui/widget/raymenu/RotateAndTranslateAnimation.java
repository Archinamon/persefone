 ...
 */
package mobi.anoda.archinamon.kernel.persefone.ui.widget.raymenu;

import android.view.animation.Animation;
import android.view.animation.Transformation;

/**
 * An animation that controls the position of an object, and make the object rotate on its center at the same time.
 */
public class RotateAndTranslateAnimation extends Animation {
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        if (mPivotX == 0.0f && mPivotY == 0.0f) {
            ...
            t.getMatrix()
             .setRotate(degrees, mPivotX, mPivotY);
        }
