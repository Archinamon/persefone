...
public abstract class CoreAsyncTask<Params, Progress, Result> {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        final CoreAsyncTask mTask;
        final Data[]        mData;

        @SafeVarargs
        AsyncTaskResult(CoreAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }

    private static final String TAG               = CoreAsyncTask.class.getSimpleName();
    ...
    protected static volatile PowerManager.WakeLock   sWakeLock        = null;
    ...
    private Result postResult(Result result) {
        @SuppressWarnings("unchecked") Message message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskResult<>(this, result));
     ...
     */
    public final CoreAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final CoreAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
