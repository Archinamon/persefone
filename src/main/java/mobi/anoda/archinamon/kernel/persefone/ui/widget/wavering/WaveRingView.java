...
public class WaveRingView extends View {
    ...
    private void switchToState(int state, float x, float y) {
        switch (state) {
            ...
            case STATE_FIRST_TOUCH:
                ...
                deactivateTargets();
                showTargets(!mShowTargetsOnIdle);
    ...
    private void doFinish() {
        ...
        if (targetHit) {
            ...
            if (!mShowTargetsOnIdle) hideTargets(true, false);
        }
    ...
    private void internalSetTargetResources(int resourceId) {
        ...
        for (TargetDrawable target : targets) {
    ...
    public void ping() {
        if (mFeedbackCount > 0) {
            ...
            if (waveAnimations.size() > 0 && waveAnimations.get(0).getAnimator().isRunning()) {
                long t = waveAnimations.get(0).getAnimator().getCurrentPlayTime();
    ...
    private boolean replaceTargetDrawables(Resources res, int existingResourceId,
        ...
        for (TargetDrawable target : drawables) {
    ...
    public void setShowTargetsOnIdle(boolean showTargetsOnIdle) {
        this.mShowTargetsOnIdle = showTargetsOnIdle;
    }
}
