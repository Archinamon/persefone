...
public class ArcSeekBar extends View {
    ...
    public interface OnSeekArcChangeListener {
         ...
         *
         * @param arcSeekBar The SeekArc whose progress has changed
         * @param progress   The current progress level. This will be in the range 0..max where max was set by {@link ProgressBar#setMax(int)}. (The default value for max is 100.)
         ...
         *
         * @param arcSeekBar The SeekArc in which the touch gesture began
         */
    ...
    private static final String TAG                    = ArcSeekBar.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int thumbHalfHeight, thumbHalfWidth;
    ...
    /**
     * Sets a listener to receive notifications of changes to the SeekArc's progress level. Also provides notifications of when the user starts and stops a touch gesture within the SeekArc.
     *
    ...
    public int getArcDiameter() {
        return Math.min(getHeight(), getWidth()) - getPaddingLeft();
    }
}