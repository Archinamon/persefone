...
public final class ExtAndroidHttpClient implements HttpClient {
    ...
    private static final String TAG = ExtAndroidHttpClient.class.getSimpleName();

    private static String[] textContentTypes = new String[] {"text/",
                                                             "application/xml",
                                                             "application/json"};
    private final DefaultHttpClient mClientDelegate;
     ...
     */
    public static ExtAndroidHttpClient newInstance(String userAgent, Context context) {
        ...
        return new ExtAndroidHttpClient(manager, params);
    }
     ...
     * @return AndroidHttpClient for you to use for all your requests.
     */
    public static ExtAndroidHttpClient newInstance(String userAgent) {
        return newInstance(userAgent, null /* session cache */);
    }

    private RuntimeException mLeakedException = new IllegalStateException("AndroidHttpClient created and never closed");

    private ExtAndroidHttpClient(ClientConnectionManager ccm, HttpParams params) {
        this.mClientDelegate = new DefaultHttpClient(ccm, params) {
    ...
    public CookieStore getCookieStore() {
        return mClientDelegate.getCookieStore();
    }

    @Implement
    public HttpParams getParams() {
        return mClientDelegate.getParams();
    }

    @Implement
    public ClientConnectionManager getConnectionManager() {
        return mClientDelegate.getConnectionManager();
    }

    @Implement
    public HttpResponse execute(HttpUriRequest request) throws IOException {
        return mClientDelegate.execute(request);
    }

    @Implement
    public HttpResponse execute(HttpUriRequest request, HttpContext context)
            throws IOException {
        return mClientDelegate.execute(request, context);
    }

    @Implement
    public HttpResponse execute(HttpHost target, HttpRequest request)
            throws IOException {
        return mClientDelegate.execute(target, request);
    }

    @Implement
    public HttpResponse execute(HttpHost target, HttpRequest request, HttpContext context) throws IOException {
        return mClientDelegate.execute(target, request, context);
    }

    @Implement
    public <T> T execute(HttpUriRequest request, ResponseHandler<? extends T> responseHandler)
            throws IOException, ClientProtocolException {
        return mClientDelegate.execute(request, responseHandler);
    }

    @Implement
    public <T> T execute(HttpUriRequest request, ResponseHandler<? extends T> responseHandler, HttpContext context)
            throws IOException, ClientProtocolException {
        return mClientDelegate.execute(request, responseHandler, context);
    }

    @Implement
    public <T> T execute(HttpHost target, HttpRequest request, ResponseHandler<? extends T> responseHandler) throws IOException,
            ClientProtocolException {
        return mClientDelegate.execute(target, request, responseHandler);
    }

    @Implement
    public <T> T execute(HttpHost target, HttpRequest request, ResponseHandler<? extends T> responseHandler, HttpContext context)
            throws IOException, ClientProtocolException {
        return mClientDelegate.execute(target, request, responseHandler, context);
    }
